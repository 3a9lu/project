using ComputerStoreService.Models;
using ComputerStoreService.Models.Client;
...
namespace ComputerStoreService.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Token(string username, string password)
        {
            ...
            if (identity == null)
            {
                return BadRequest(new { errorText = "Неправильная почта или пароль." });
            }
